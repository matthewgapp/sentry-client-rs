...
pub async fn create_a_new_project(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    team_slug: &str,
    create_a_new_project_request: crate::models::CreateANewProjectRequest,
) -> Result<
    crate::models::ListAnOrganizationSTeams200ResponseInnerProjectsInner,
    Error<CreateANewProjectError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateANewProjectError> =
...
pub async fn create_a_new_team(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    create_a_new_team_request: crate::models::CreateANewTeamRequest,
) -> Result<crate::models::CreateANewTeam201Response, Error<CreateANewTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateANewTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_a_team(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    team_slug: &str,
) -> Result<(), Error<DeleteATeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteATeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_a_team_quote_s_projects(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    team_slug: &str,
    cursor: Option<&str>,
) -> Result<
    Vec<crate::models::ListATeamSProjects200ResponseInner>,
    Error<ListATeamQuoteSProjectsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListATeamQuoteSProjectsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_an_organization_quote_s_teams(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    cursor: Option<&str>,
) -> Result<
    Vec<crate::models::ListAnOrganizationSTeams200ResponseInner>,
    Error<ListAnOrganizationQuoteSTeamsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAnOrganizationQuoteSTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_a_team(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    team_slug: &str,
) -> Result<crate::models::RetrieveATeam200Response, Error<RetrieveATeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveATeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_event_counts_for_a_team(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    team_slug: &str,
    stat: Option<&str>,
...
) -> Result<Vec<Vec<i32>>, Error<RetrieveEventCountsForATeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveEventCountsForATeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_a_team(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    team_slug: &str,
    update_a_team_request: crate::models::UpdateATeamRequest,
) -> Result<crate::models::CreateANewTeam201Response, Error<UpdateATeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateATeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
