...
pub async fn bulk_mutate_a_list_of_issues(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    project_slug: &str,
    bulk_mutate_a_list_of_issues_request: crate::models::BulkMutateAListOfIssuesRequest,
    id: Option<i32>,
    status: Option<&str>,
) -> Result<crate::models::BulkMutateAListOfIssues200Response, Error<BulkMutateAListOfIssuesError>>
{
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BulkMutateAListOfIssuesError> =
...
pub async fn bulk_remove_a_list_of_issues(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    project_slug: &str,
    id: Option<i32>,
) -> Result<(), Error<BulkRemoveAListOfIssuesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BulkRemoveAListOfIssuesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_a_project_quote_s_events(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    project_slug: &str,
    full: Option<bool>,
    ...
    Vec<crate::models::ListAProjectSEvents200ResponseInner>,
    Error<ListAProjectQuoteSEventsError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = full {
        local_var_req_builder =
            local_var_req_builder.query(&[("full", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAProjectQuoteSEventsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_a_project_quote_s_issues(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    project_slug: &str,
    stats_period: Option<&str>,
    short_id_lookup: Option<bool>,
    query: Option<&str>,
    cursor: Option<&str>,
) -> Result<
    Vec<crate::models::ListAProjectSIssues200ResponseInner>,
    Error<ListAProjectQuoteSIssuesError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = short_id_lookup {
        local_var_req_builder =
            local_var_req_builder.query(&[("shortIdLookup", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAProjectQuoteSIssuesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_a_tag_quote_s_values_related_to_an_issue(
    configuration: &configuration::Configuration,
    issue_id: &str,
    key: &str,
) -> Result<
    Vec<crate::models::ListATagSValuesRelatedToAnIssue200ResponseInner>,
    Error<ListATagQuoteSValuesRelatedToAnIssueError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        issue_id = crate::apis::urlencode(issue_id),
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListATagQuoteSValuesRelatedToAnIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_an_issue_quote_s_events(
    configuration: &configuration::Configuration,
    issue_id: &str,
    full: Option<bool>,
) -> Result<
    Vec<crate::models::ListAProjectSEvents200ResponseInner>,
    Error<ListAnIssueQuoteSEventsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAnIssueQuoteSEventsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_an_issue_quote_s_hashes(
    configuration: &configuration::Configuration,
    issue_id: &str,
    cursor: Option<&str>,
) -> Result<
    Vec<crate::models::ListAnIssueSHashes200ResponseInner>,
    Error<ListAnIssueQuoteSHashesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAnIssueQuoteSHashesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_an_issue(
    configuration: &configuration::Configuration,
    issue_id: &str,
) -> Result<(), Error<RemoveAnIssueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveAnIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_an_event_for_a_project(
    configuration: &configuration::Configuration,
    organization_slug: &str,
    project_slug: &str,
    event_id: &str,
) -> Result<
    crate::models::RetrieveAnEventForAProject200Response,
    Error<RetrieveAnEventForAProjectError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveAnEventForAProjectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_an_issue(
    configuration: &configuration::Configuration,
    issue_id: &str,
) -> Result<crate::models::RetrieveAnIssue200Response, Error<RetrieveAnIssueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveAnIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_tag_details(
    configuration: &configuration::Configuration,
    issue_id: &str,
    key: &str,
) -> Result<crate::models::RetrieveTagDetails200Response, Error<RetrieveTagDetailsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveTagDetailsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_the_latest_event_for_an_issue(
    configuration: &configuration::Configuration,
    issue_id: &str,
) -> Result<
    crate::models::RetrieveAnEventForAProject200Response,
    Error<RetrieveTheLatestEventForAnIssueError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveTheLatestEventForAnIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn retrieve_the_oldest_event_for_an_issue(
    configuration: &configuration::Configuration,
    issue_id: &str,
) -> Result<
    crate::models::RetrieveAnEventForAProject200Response,
    Error<RetrieveTheOldestEventForAnIssueError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RetrieveTheOldestEventForAnIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_an_issue(
    configuration: &configuration::Configuration,
    issue_id: &str,
    update_an_issue_request: crate::models::UpdateAnIssueRequest,
) -> Result<crate::models::UpdateAnIssue200Response, Error<UpdateAnIssueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateAnIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
