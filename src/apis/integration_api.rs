...
pub async fn create_an_external_issue(
    configuration: &configuration::Configuration,
    uuid: &str,
    create_an_external_issue_request: crate::models::CreateAnExternalIssueRequest,
) -> Result<crate::models::CreateAnExternalIssue200Response, Error<CreateAnExternalIssueError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateAnExternalIssueError> =
...
pub async fn delete_an_external_issue(
    configuration: &configuration::Configuration,
    uuid: &str,
    external_issue_id: &str,
) -> Result<(), Error<DeleteAnExternalIssueError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        uuid = crate::apis::urlencode(uuid),
        external_issue_id = crate::apis::urlencode(external_issue_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteAnExternalIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_an_organization_quote_s_integration_platform_installations(
    configuration: &configuration::Configuration,
    organization_slug: &str,
) -> Result<
    Vec<crate::models::ListAnOrganizationSIntegrationPlatformInstallations200ResponseInner>,
    Error<ListAnOrganizationQuoteSIntegrationPlatformInstallationsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ListAnOrganizationQuoteSIntegrationPlatformInstallationsError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
