...
impl ResolveAnEventId200ResponseEventUser {
    pub fn new(username: Option<String>, name: Option<String>, ip_address: Option<String>, email: Option<String>, data: Option<crate::models::ResolveAnEventId200ResponseEventUserData>, id: String) -> ResolveAnEventId200ResponseEventUser {
