...
impl RetrieveAnEventForAProject200Response {
    pub fn new(event_id: String, dist: Option<String>, user_report: Option<serde_json::Value>, previous_event_id: Option<String>, message: String, id: String, size: i32, errors: Vec<crate::models::ResolveAnEventId200ResponseEventErrorsInner>, platform: String, next_event_id: Option<String>, r#type: String, metadata: crate::models::RetrieveAnEventForAProject200ResponseMetadata, tags: Vec<crate::models::RetrieveAnEventForAProject200ResponseTagsInner>, date_created: String, date_received: String, user: Option<crate::models::ResolveAnEventId200ResponseEventUser>, entries: Vec<crate::models::ResolveAnEventId200ResponseEventEntriesInner>, packages: serde_json::Value, sdk: crate::models::RetrieveAnEventForAProject200ResponseSdk, _meta: crate::models::RetrieveAnEventForAProject200ResponseMeta, contexts: serde_json::Value, fingerprints: Vec<String>, context: serde_json::Value, release: Option<crate::models::RetrieveAnEventForAProject200ResponseRelease>, group_id: String, title: String) -> RetrieveAnEventForAProject200Response {
        RetrieveAnEventForAProject200Response {
            ...
            fingerprints,
            context,
            release: if let Some(x) = release {Some(Box::new(x))} else {None},
            group_id,
            title,
        }
    }
