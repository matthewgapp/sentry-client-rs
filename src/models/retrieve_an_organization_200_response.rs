...
impl RetrieveAnOrganization200Response {
    pub fn new(access: Vec<String>, allow_shared_issues: bool, available_roles: Vec<crate::models::RetrieveAnOrganization200ResponseAvailableRolesInner>, avatar: crate::models::ListAnOrganizationSTeams200ResponseInnerAvatar, data_scrubber: bool, data_scrubber_defaults: bool, date_created: String, default_role: String, enhanced_privacy: bool, experiments: serde_json::Value, features: Vec<String>, id: String, is_default: bool, is_early_adopter: bool, name: String, onboarding_tasks: Vec<serde_json::Value>, open_membership: bool, pending_access_requests: i64, projects: Vec<crate::models::RetrieveAnOrganization200ResponseProjectsInner>, quota: serde_json::Value, require2_fa: bool, safe_fields: Vec<String>, scrape_java_script: bool, scrub_ip_addresses: bool, sensitive_fields: Vec<String>, slug: String, status: crate::models::RetrieveAnOrganization200ResponseAvailableRolesInner, store_crash_reports: i64, teams: Vec<crate::models::CreateANewTeam201Response>, trusted_relays: Vec<String>) -> RetrieveAnOrganization200Response {
