...
pub struct RetrieveAProject200ResponseOptions {
    ...
    #[serde(rename = "filters:blacklisted_ips", skip_serializing_if = "Option::is_none")]
    pub filters_colon_blacklisted_ips: Option<String>,
    #[serde(rename = "filters:error_messages", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "sentry:csp_ignored_sources", skip_serializing_if = "Option::is_none")]
    pub sentry_colon_csp_ignored_sources: Option<String>,
    #[serde(rename = "sentry:csp_ignored_sources_defaults", skip_serializing_if = "Option::is_none")]
    pub sentry_colon_csp_ignored_sources_defaults: Option<bool>,
    #[serde(rename = "sentry:reprocessing_active", skip_serializing_if = "Option::is_none")]
