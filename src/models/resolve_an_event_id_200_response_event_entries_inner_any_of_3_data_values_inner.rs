...
impl ResolveAnEventId200ResponseEventEntriesInnerAnyOf3DataValuesInner {
    pub fn new(
        ...
        raw_stacktrace: Option<serde_json::Value>,
        mechanism: Option<crate::models::ResolveAnEventId200ResponseEventEntriesInnerAnyOf3DataValuesInnerMechanism>,
        thread_id: Option<String>,
        value: String,
        r#type: String,
    ) -> ResolveAnEventId200ResponseEventEntriesInnerAnyOf3DataValuesInner {
        ResolveAnEventId200ResponseEventEntriesInnerAnyOf3DataValuesInner {
            stacktrace: if let Some(x) = stacktrace {
                Some(Box::new(x))
            } else {
                None
            },
            module,
            raw_stacktrace,
            mechanism: if let Some(x) = mechanism {
                Some(Box::new(x))
            } else {
                None
            },
