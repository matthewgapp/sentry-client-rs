...
impl ListAnOrganizationSTeams200ResponseInnerProjectsInner {
    pub fn new(avatar: crate::models::ListAnOrganizationSTeams200ResponseInnerAvatar, color: String, date_created: String, features: Vec<String>, first_event: Option<String>, has_access: bool, id: String, is_bookmarked: bool, is_internal: bool, is_member: bool, is_public: bool, name: String, platform: Option<String>, slug: String, status: Status) -> ListAnOrganizationSTeams200ResponseInnerProjectsInner {
