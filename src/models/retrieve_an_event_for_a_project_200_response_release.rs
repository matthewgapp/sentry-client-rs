...
pub struct RetrieveAnEventForAProject200ResponseRelease {
    ...
    pub last_deploy:
        Option<Box<crate::models::RetrieveAnEventForAProject200ResponseReleaseOneOfLastDeploy>>,
...
impl RetrieveAnEventForAProject200ResponseRelease {
    pub fn new(
        ...
        last_deploy: Option<
            crate::models::RetrieveAnEventForAProject200ResponseReleaseOneOfLastDeploy,
        >,
        ...
        RetrieveAnEventForAProject200ResponseRelease {
            ...
            first_event,
            last_commit,
            last_deploy: if let Some(x) = last_deploy {
                Some(Box::new(x))
            } else {
                None
            },
