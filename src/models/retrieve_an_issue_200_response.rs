...
impl RetrieveAnIssue200Response {
    pub fn new(
        ...
        count: String,
        culprit: String,
        first_release: Option<crate::models::RetrieveAnIssue200ResponseFirstRelease>,
        first_seen: String,
        has_seen: bool,
        id: String,
        is_bookmarked: bool,
        is_public: bool,
        is_subscribed: bool,
        last_release: Option<serde_json::Value>,
        last_seen: String,
        level: String,
        logger: Option<String>,
        metadata: crate::models::ListAProjectSIssues200ResponseInnerMetadata,
        num_comments: i32,
        participants: Vec<serde_json::Value>,
        permalink: String,
        plugin_actions: Vec<Vec<String>>,
        plugin_contexts: Vec<String>,
        plugin_issues: Vec<serde_json::Value>,
        project: crate::models::ListAProjectSIssues200ResponseInnerProject,
        seen_by: Vec<serde_json::Value>,
        share_id: Option<String>,
        short_id: String,
        stats: crate::models::RetrieveAnIssue200ResponseStats,
        status: Status,
        status_details: serde_json::Value,
        subscription_details: Option<serde_json::Value>,
        ...
        RetrieveAnIssue200Response {
            ...
            count,
            culprit,
            first_release: if let Some(x) = first_release {
                Some(Box::new(x))
            } else {
                None
            },
