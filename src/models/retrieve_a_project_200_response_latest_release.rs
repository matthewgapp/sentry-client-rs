...
impl RetrieveAProject200ResponseLatestRelease {
    pub fn new(authors: Vec<crate::models::RetrieveAProject200ResponseLatestReleaseAuthorsInner>, commit_count: i32, data: serde_json::Value, date_created: String, date_released: Option<String>, deploy_count: i32, first_event: Option<String>, last_commit: Option<serde_json::Value>, last_deploy: Option<serde_json::Value>, last_event: Option<String>, new_groups: i32, owner: Option<String>, projects: Vec<crate::models::RetrieveAProject200ResponseLatestReleaseProjectsInner>, r#ref: Option<String>, short_version: String, url: Option<String>, version: String) -> RetrieveAProject200ResponseLatestRelease {
