...
impl ResolveAnEventId200ResponseEventEntriesInnerAnyOf1Data {
    pub fn new(
        ...
        cookies: Option<Vec<Vec<String>>>,
        inferred_content_type: Option<String>,
        env: Option<crate::models::ResolveAnEventId200ResponseEventEntriesInnerAnyOf1DataEnv>,
