...
impl ResolveAnEventId200ResponseEvent {
    pub fn new(_meta: crate::models::ResolveAnEventId200ResponseEventMeta, context: crate::models::ResolveAnEventId200ResponseEventContext, contexts: serde_json::Value, date_created: String, date_received: String, dist: Option<String>, entries: Vec<crate::models::ResolveAnEventId200ResponseEventEntriesInner>, errors: Vec<crate::models::ResolveAnEventId200ResponseEventErrorsInner>, event_id: String, fingerprints: Vec<String>, group_id: String, id: String, message: String, metadata: crate::models::ResolveAnEventId200ResponseEventMetadata, packages: crate::models::ResolveAnEventId200ResponseEventPackages, platform: String, sdk: Option<serde_json::Value>, size: i32, tags: Vec<crate::models::ResolveAnEventId200ResponseEventTagsInner>, r#type: String, user: Option<crate::models::ResolveAnEventId200ResponseEventUser>, title: String) -> ResolveAnEventId200ResponseEvent {
