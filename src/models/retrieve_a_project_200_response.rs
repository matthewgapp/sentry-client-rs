...
impl RetrieveAProject200Response {
    pub fn new(
        ...
        is_member: bool,
        is_public: bool,
        latest_release: Option<crate::models::RetrieveAProject200ResponseLatestRelease>,
        name: String,
        options: crate::models::RetrieveAProject200ResponseOptions,
        ...
        RetrieveAProject200Response {
            ...
            is_member,
            is_public,
            latest_release: if let Some(x) = latest_release {
                Some(Box::new(x))
            } else {
                None
            },
